...
'''
    ...
    def __init__(self, name, lang='go'):
        ...
        if self.lang == 'py':
            self.files = {
                f'etl/{self.name}.ipynb': self.script_content,
                }
        else:
            self.script_content = '''
package main
...
func main(){
    ...
    def create(self):
        ...
        if self.lang == 'py':
            with open('etl/requirements.txt', 'w') as f:
                f.write('''
anyio==4.10.0
argon2-cffi==25.1.0
...
''')
        ...
        # shutil.copy(logo_directory, f'etl/static/logo/gupy_logo.png')

        # splashscreen_directory = os.path.join(os.path.dirname(current_directory), 'gupy_splashscreen.png')       
        
        # shutil.copy(splashscreen_directory, f'etl/static/splashscreen/gupy_splashscreen.png')

        # ico_directory = os.path.join(os.path.dirname(current_directory), 'gupy.ico')       
        
        # shutil.copy(ico_directory, f'etl/static/icon/gupy.ico')
    ...
    def distribute(self, system, folder, delim, NAME, VERSION):
        try:
            ...
            if os.path.exists(f'{NAME}.ipynb'):
...
'''
    ...
    # Execute notebook in-place (overwrite with outputs)
    cmd = [
        exe, "-m", "jupyter", "nbconvert",
        "--execute",
        "--to",
        "markdown",
        "--stdout",

...
<head>
  ...
  <link rel="icon" href="{{url_for('static', filename='logo/gupy_logo.png')}}" type="image/png">
...
<body>
  <div id="app" style="text-align: center;">
    <center>
      <div class="h-full">
        <img class="mt-4 mask mask-squircle  h-96 w-96 max-h-full max-w-full object-contain  hover:-translate-y-2 ease-in-out transition" src="{{url_for('static', filename='logo/gupy_logo.png')}}" />
        <br>
        <br>
